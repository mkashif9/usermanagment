...
module.exports = sequelize.define('projects',{
  ...
  shortDescription:{
    ...
    validate :{
      ...
      notEmpty:{
        msg:'shortDescription cannot be Empaty'
      }
    }
  },
  description:{
    ...
    validate :{
      ...
      notEmpty:{
        msg:'description cannot be Empaty'
      }
    }
  },
  productUrl:{
    ...
    validate :{
      ...
      notEmpty:{
        msg:'productUrl cannot be Empaty'
      },
      isUrl:{
